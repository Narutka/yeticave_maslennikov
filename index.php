...
<main class="container">
    <section class="promo">
        ...
        <ul class="promo__list">
            ...
            <?php foreach($categories as $class_category => $name_category): ?>
            <li class="promo__item promo__item--<?= $class_category?>">    
                <a class="promo__link" href="pages/all-lots.html"><?= $name_category ?></a>
            </li>
            <?php endforeach; ?>
        </ul>
    </section>
        ...
        <ul class="lots__list">
            ...
            <li class="lots__item lot">
                <div class="lot__image">
                    <img src="<?=$lot["src"]?>" width="350" height="260" alt="">
                </div>
                <div class="lot__info">
